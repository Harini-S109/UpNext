    ...
    const changeToInProgress = async () => {
        ...
        try {
            ...
            if (response.data && response.data.task) {
                // If the backend update is successful, update the frontend state as well
                onStatusChange(taskId, "IN PROGRESS"); // Update the task status in parent component state
            }
        } catch (error) {
            // Handle errors
